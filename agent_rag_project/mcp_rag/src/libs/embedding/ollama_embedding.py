...
class OllamaEmbedding(BaseEmbedding):
    ...
    DEFAULT_BASE_URL = "http://localhost:11434"# 模型在本地Ollama的标准端口
    ...
    def embed(
        ...
        **kwargs: Any,
        ...
        # Process each text individually (Ollama API expects single prompt) 一块一块处理
        for text in texts:
            payload = {
                "model": self.model,
                "prompt": text,
