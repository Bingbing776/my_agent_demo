...
class VectorUpserter:
    ...
    def __init__(self, settings: Settings, collection_name: Optional[str] = None):
        ...
        kwargs = {}
        if collection_name:
            kwargs['collection_name'] = collection_name # 指定要把数据存到哪个“集合”
        self.vector_store = VectorStoreFactory.create(settings, **kwargs)  #工厂模式生成一个数据库客户端实例化对象
