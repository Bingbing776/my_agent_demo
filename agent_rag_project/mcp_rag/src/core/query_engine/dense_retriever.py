...
class DenseRetriever:
    ...
    def retrieve(
        ...
        """
        # Validate inputs校验输入和依赖
        self._validate_query(query)
        self._validate_dependencies()
        
        # Use default top_k if not specified决定用topk几
        ...
        # Step 1: Embed the query 把 query 做 embedding
        try:
        ...
        # Step 2: Query the vector store  去向量库查相似内容
        try:
        ...
        # Step 3: Transform to RetrievalResult objects 转成统一格式
