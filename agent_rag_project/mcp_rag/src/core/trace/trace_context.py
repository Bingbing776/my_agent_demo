...
class TraceContext:
    ...
    def finish(self) -> None:
        ...
        self._finish_mono = time.monotonic() #那个拿来算耗时的时间
        self.finished_at = datetime.now(timezone.utc).isoformat() # 现在的 UTC 时间
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        把 TraceContext 这个对象，变成一个普通 Python 字典
        Returns:
    ...
    # 从所有 stages 里，找出某个阶段对应的 data 内容
